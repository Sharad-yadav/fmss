                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value={{FrontUser('email') }} placeholder="Email"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <select class="form-control">
                                                        ...
                                                        <option value="ne" selected>Nepali</option>
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <button type="button"
                                                        class="btn btn-label-brand btn-bold btn-sm kt-margin-t-5 kt-margin-b-5">Setup
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="kt-checkbox-single">
                                                        <label class="kt-checkbox">
                                                            <input type="checkbox"> Require personal information to reset
                                                            your password.
                                                            <span></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="form-group row kt-margin-t-10 kt-margin-b-10">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <button type="button"
                                                        class="btn btn-label-danger btn-bold btn-sm kt-margin-t-5 kt-margin-b-5">Deactivate
                                                        your account ?</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="kt-checkbox-list">
                                                        ...
                                                        <label class="kt-checkbox">
                                                            <input type="checkbox" checked="checked"> Someone adds you as
                                                            a connection
                                                            <span></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="kt-checkbox-list">
                                                        ...
                                                        <label class="kt-checkbox">
                                                            <input type="checkbox" checked="checked"> News about Metronic
                                                            on partner products and other services
                                                            <span></span>
                                                        </label>
                                                        <label class="kt-checkbox">
