    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">Import Teacher</h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a href="{{ url('admin/teacher/export') }}" class="btn btn-primary">
        ...
        {!! Form::open(['route' => 'admin.teacher.import', 'class' => 'kt-form kt-form--label-right', 'method' => 'post', 'files' => true]) !!}
            ...
            <div class="kt-form__actions">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <a href="{{ route('admin.teacher.index') }}" type="reset" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
