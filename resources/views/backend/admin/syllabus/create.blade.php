    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">Create Syllabus</h3>
            </div>
        </div>
        {!! Form::open(['route' => 'admin.syllabus.store', 'files' => true, 'class' => 'kt-form kt-form--label-right', 'method' => 'post']) !!}
        @include('backend.admin.syllabus.form', ['formAction' => 'Save'])
        {!! Form::close() !!}
    </div>
@endsection
@push('scripts')
