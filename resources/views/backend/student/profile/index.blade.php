        ...
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a href="{{ route('student.profile.edit', frontUser('id')) }}" class="btn btn-primary">
                ...
                <div class="kt-section__body">
                    <div class="form-group row">
                        <div class="offset-md-1 col-lg-6 col-xl-6">
                            <img src="{{ getImageUrl(\App\Constants\RoleConstant::STUDENT_ID) }}" style="height:140px; width:140px; border-radius: 50%;" alt="">
                        </div>
                    </div>
                    <div class="form-group row">
