...
@section('content')
    <div class="kt-portlet">
        ...
        {!! Form::open(['route' => 'teacher.password.change', 'class' => 'kt-form kt-form--label-right', 'method' => 'post']) !!}
            ...
            <div class="kt-form__actions">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-xl-9">
                        ...
                        <a href="{{ route('teacher.profile.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
