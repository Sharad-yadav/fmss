...
<body class="bg-gradient-to-r from-blue-400 to-white flex justify-center items-center h-screen">
    <div class="bg-gradient-to-b from-blue-100 to-pink-200  rounded-lg p-8 shadow-lg text-center">
        ...
        <div class="mt-4">
            @if (Route::has('login'))
                <div class="auth-links">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="auth-link w-70 bg-blue-400 hover:bg-blue-500 text-white py-2 px-6 rounded-md font-semibold shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">Log
                            in</a>
                    @endauth
                </div>
            @endif
